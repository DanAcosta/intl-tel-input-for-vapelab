    ...
    jQuery(function() { 
        ...
        if(billing_phone != null){
            ...
            function todosLosCamposCompletos() {
                var fields = document.querySelectorAll("form.checkout.woocommerce-checkout input[type=text], form.checkout.woocommerce-checkout input[type=email], form.checkout.woocommerce-checkout input[type=tel]");
